...
本文以通俗易懂的方式来讲解知识图谱相关的知识、介绍从零开始搭建知识图谱过程当中需要经历的步骤以及每个阶段。本次组队学习还将动手实践一个关于kg在智能问答中的应用。
## （一）什么是知识图谱
...
- 例如基于下图Schema构建的知识图谱中仅可含作品、地方组织、人物；其中作品的属性为电影与音乐、地方组织的属性为当地的商业（eg：饭店、俱乐部等）、人物的属性为歌手
- tips：本次组队学习不涉及schema的构建
![schema定义.PNG](https://i.loli.net/2020/12/06/zxMLupBIewb2jFR.png)

知识图谱市人工智能很重要的一个分支, 人工智能的目标是为了让机器具备像人一样理性思考及做事的能力 ->
...
5. https://schema.org/
6. https://ai.baidu.com/tech/kg/schema
7. https://tech.meituan.com/2018/11/01/meituan-ai-nlp.html
